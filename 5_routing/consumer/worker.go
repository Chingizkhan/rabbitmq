...
func main() {
	...
	// logs_direct algorithm - a message goes to the queues whose binding key exactly matches the routing key of the message.

	// Bindings can take an extra routing_key parameter. To avoid the confusion with
	// a Channel.Publish parameter we're going to call it a binding key
